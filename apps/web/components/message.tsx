  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-[#6D91EE] to-[#3B4CAB] flex justify-center items-center p-4">
      <div className="flex flex-col w-full max-w-4xl h-[80vh] bg-white bg-opacity-10 backdrop-blur-lg p-6 rounded-lg shadow-lg space-y-4 relative">
        ...
        {/* Chat window */}
        <div className="flex-grow overflow-y-auto px-4 py-2 space-y-3 scrollbar-custom mb-6">
        ...
        {/* Input section with adjusted hover and color */}
        <form onSubmit={handleSubmit} className="flex items-center justify-between space-x-4 py-4 px-6 bg-[#6D91EE] rounded-full shadow-2xl">
          <input
            type="text"
            required
            placeholder="Type your message..."
            className="flex-grow px-6 py-3 rounded-full border border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500 bg-[#3B4CAB] text-white placeholder-white transition-transform transform focus:ring-offset-2 hover:scale-105"
            name="message"
            value={message}
          ...
          <button
            type="submit"
            className="px-6 py-3 bg-yellow-400 hover:bg-yellow-500 text-white font-semibold rounded-full transition-transform transform hover:scale-105 shadow-xl hover:shadow-3xl"
          >
            Send
          </button>
        </form>
